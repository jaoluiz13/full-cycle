...
import ChangeAddressCreateCustomerHandler from "../../customer/event/handler/change-address-customer.handler";
import Log1WhenCreateCustomerHandler from "../../customer/event/handler/log1-created-customer-handler copy";
import Log2WhenCreateCustomerHandler from "../../customer/event/handler/log2-created-customer-handler";
