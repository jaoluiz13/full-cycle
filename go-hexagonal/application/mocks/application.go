...
import (
	...
	application "github.com/jaoluiz13/go-hexagonal/application"
)
...
// MockProducServiceInterface is a mock of ProducServiceInterface interface.
type MockProducServiceInterface struct {
	ctrl     *gomock.Controller
	recorder *MockProducServiceInterfaceMockRecorder
}

// MockProducServiceInterfaceMockRecorder is the mock recorder for MockProducServiceInterface.
type MockProducServiceInterfaceMockRecorder struct {
	mock *MockProducServiceInterface
}

// NewMockProducServiceInterface creates a new mock instance.
func NewMockProducServiceInterface(ctrl *gomock.Controller) *MockProducServiceInterface {
	mock := &MockProducServiceInterface{ctrl: ctrl}
	mock.recorder = &MockProducServiceInterfaceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProducServiceInterface) EXPECT() *MockProducServiceInterfaceMockRecorder {
	return m.recorder
}

// Create mocks base method.
func (m *MockProducServiceInterface) Create(name string, price float64) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProducServiceInterfaceMockRecorder) Create(name, price interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockProducServiceInterface)(nil).Create), name, price)
}

// Disable mocks base method.
func (m *MockProducServiceInterface) Disable(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Disable indicates an expected call of Disable.
func (mr *MockProducServiceInterfaceMockRecorder) Disable(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Disable", reflect.TypeOf((*MockProducServiceInterface)(nil).Disable), product)
}

// Enable mocks base method.
func (m *MockProducServiceInterface) Enable(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Enable indicates an expected call of Enable.
func (mr *MockProducServiceInterfaceMockRecorder) Enable(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Enable", reflect.TypeOf((*MockProducServiceInterface)(nil).Enable), product)
}

// Get mocks base method.
func (m *MockProducServiceInterface) Get(id string) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProducServiceInterfaceMockRecorder) Get(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockProducServiceInterface)(nil).Get), id)
}
